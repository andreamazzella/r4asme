...
* Examine the proportionality assumption in Cox models
 ...
 - with a test for Martingale residuals
...
## Bonus: Martingale residuals

There is a quicker way of testing the assumption of proportional hazards: ormal testing of Martingale residuals, with function `cox.zph()`.
```{r}
# Test 
