...
You can stratify by another categorical variable by adding it after a + in the right hand-side of the formula in `pyears()`. You then change the options in `summary()` to hide events and person-time. There are options to calculate RR insead of showing the risks, but I can't get them to work.
...
# broken code
# summary(py, n = F, event = F, pyears = F, rr = T, ci.rr = T, scale = 1000)
